...
Public Class IUGestionPersonas
    ...
    Dim Cantidad_Dedos As Integer = 0
    Dim EstadoModificado As Boolean = False
    Dim Dedo1 As Integer = 0
    Dim Dedo2 As Integer = 0
    ...
    Private Sub MostrarPersona(ByVal Posicion As Integer)
        ...
        CmbEdoCivil.SelectedIndex = IUPrincipal.Personas.Item(Posicion).ProEdoCivil + 1
        ...
        Dedo1 = IUPrincipal.Personas.Item(Posicion).ProDedo_1
        Dedo2 = IUPrincipal.Personas.Item(Posicion).ProDedo_2
        If IUPrincipal.Profesiones.Count > 0 Then
    ...
    Private Sub Guardar()
        If EstadoFormulario = "Agregando" Then
            ...
            IUPrincipal.Persona.ProDedo_1 = Dedo1
            IUPrincipal.Persona.ProDedo_2 = Dedo2
            ...
            If IUPrincipal.Persona.ProLentes = True Then
                Lentes = 1
            Else
                Lentes = 0
            End If
            If IUPrincipal.Persona.ProFuma = True Then
                Fuma = 1
            Else
                Fuma = 0
            End If
            If IUPrincipal.Persona.ProOperaciones = True Then
                Operaciones = 1
            Else
                Operaciones = 0
            End If
            If IUPrincipal.Persona.ProIncapacitado = True Then
                Incapacitado = 1
            Else
                Incapacitado = 0
            End If
            If IUPrincipal.Persona.ProCertificado = True Then
                Certificado = 1
            Else
                Certificado = 0
            End If
            If bConexionExitosa Then
                IUPrincipal.Conexion.Insertar("INSERT INTO `PERSONAS_TEMP` set `Txt_Cedula` = '" + IUPrincipal.Persona.ProCedula + "',`Txt_Rif` = '" + IUPrincipal.Persona.ProRif + "',`Txt_Nombres` = '" + IUPrincipal.Persona.ProNombres + "',`Txt_Apellidos` = '" + IUPrincipal.Persona.ProApellidos + "',`Dte_Fecha_Nacimiento` = '" + IUPrincipal.Persona.ProFechaNacimiento.ToString("yyyy-MM-dd") + "',`Txt_Lugar_Nacimiento` = '" + IUPrincipal.Persona.ProLugarNacimiento + "',`Int_Sexo` = '" & IUPrincipal.Persona.ProSexo & "',`Int_Edo_Civil` = '" & IUPrincipal.Persona.ProEdoCivil & "',`Txt_Foto` = '" + IUPrincipal.Persona.ProFoto + "',`Txt_Direccion` = '" + IUPrincipal.Persona.ProDireccion + "',`Txt_Punto_Ref` = '" + IUPrincipal.Persona.ProPuntoReferencia + "',`Txt_Tel_Habitacion` = '" + IUPrincipal.Persona.ProTelefonoHabitacion + "',`Txt_Tel_Movil` = '" + IUPrincipal.Persona.ProTelefonoMovil + "',`Txt_Correo` = '" + IUPrincipal.Persona.ProCorreoElectronico + "',`Txt_Nombre_Contacto` = '" + IUPrincipal.Persona.ProNombreContacto + "',`Txt_Descripcion_Contacto` = '" + IUPrincipal.Persona.ProDescripcionContacto + "',`Txt_Tel_Contacto` = '" + IUPrincipal.Persona.ProTelefonoContacto + "',`Txt_Tel_Movil_Contacto` = '" + IUPrincipal.Persona.ProTelefonoMovilContacto + "',`Txt_Grupo_Sanguineo` = '" + IUPrincipal.Persona.ProGrupoSanguineo + "',`Int_Altura` = '" & IUPrincipal.Persona.ProAltura & "',`Int_Peso` = '" & IUPrincipal.Persona.ProPeso & "',`Int_Talla_Pantalon` = '" & IUPrincipal.Persona.ProTallaPantalon & "',`Int_Talla_Calzado` = '" & IUPrincipal.Persona.ProTallaCalzado & "',`Txt_Talla_Camisa` = '" + IUPrincipal.Persona.ProTallaCamisa + "',`Boo_Lentes` = '" & Lentes & "',`Boo_Fuma` = '" & Fuma & "',`Boo_Operaciones` = '" & Operaciones & "',`Boo_Incapacitado` = '" & Incapacitado & "',`Txt_Alergias` = '" + IUPrincipal.Persona.ProAlergias + "',`Txt_Enfermedades` = '" + IUPrincipal.Persona.ProEnfermedades + "',`Int_Estatus` = '" & IUPrincipal.Persona.ProEstatus & "',`Int_Banco` = '" & IUPrincipal.Persona.ProBanco & "',`Txt_Cuenta_Bancaria` = '" + IUPrincipal.Persona.ProCuentaBancaria + "',`Boo_Certificado` = '" & Certificado & "',`Int_Profesion` = '" & IUPrincipal.Persona.ProProfesion & "',`Txt_Habilidades` = '" + IUPrincipal.Persona.ProHabilidades + "',`Int_Dedo1` = " & IUPrincipal.Persona.ProDedo_1 & ",`Int_Dedo2` = " & IUPrincipal.Persona.ProDedo_2 & ", `Dte_fechapreempleo` = " + IUPrincipal.Persona.ProFechaPreEmpleo.ToString("yyyy-MM-dd") + ";")
            End If
            '////////////////////////////////////////////////////////
            '////////////////////////////////////////////////////////
        ElseIf EstadoFormulario = "Modificando" Then
            ...
            IUPrincipal.Personas.Item(PosicionActual).ProDedo_1 = Dedo1
            IUPrincipal.Personas.Item(PosicionActual).ProDedo_2 = Dedo2
            If CmbProfesion.Items.Count > 0 Then
            ...
            Dim Incapacitado As Integer
            Dim Certificado As Integer
            If IUPrincipal.Personas.Item(PosicionActual).ProLentes = True Then
                Lentes = 1
            Else
                Lentes = 0
            End If
            If IUPrincipal.Personas.Item(PosicionActual).ProFuma = True Then
                Fuma = 1
            Else
                Fuma = 0
            End If
            If IUPrincipal.Personas.Item(PosicionActual).ProOperaciones = True Then
                Operaciones = 1
            Else
                Operaciones = 0
            End If
            If IUPrincipal.Personas.Item(PosicionActual).ProIncapacitado = True Then
                Incapacitado = 1
            Else
                Incapacitado = 0
            End If
            If IUPrincipal.Personas.Item(PosicionActual).ProCertificado = True Then
                Certificado = 1
            Else
                Certificado = 0
            End If
            If bConexionExitosa Then
                IUPrincipal.Conexion.Insertar("UPDATE `PERSONAS_TEMP` set `Txt_Cedula` = '" + IUPrincipal.Personas.Item(PosicionActual).ProCedula + "',`Txt_Rif` = '" + IUPrincipal.Personas.Item(PosicionActual).ProRif + "',`Txt_Nombres` = '" + IUPrincipal.Personas.Item(PosicionActual).ProNombres + "',`Txt_Apellidos` = '" + IUPrincipal.Personas.Item(PosicionActual).ProApellidos + "',`Dte_Fecha_Nacimiento` = '" + DteFechaNacimiento.Value.ToString("yyyy-MM-dd") + "',`Txt_Lugar_Nacimiento` = '" + IUPrincipal.Personas.Item(PosicionActual).ProLugarNacimiento + "',`Int_Sexo` = '" & IUPrincipal.Personas.Item(PosicionActual).ProSexo & "',`Int_Edo_Civil` = '" & IUPrincipal.Personas.Item(PosicionActual).ProEdoCivil & "',`Txt_Foto` = '" + IUPrincipal.Personas.Item(PosicionActual).ProFoto + "',`Txt_Direccion` = '" + IUPrincipal.Personas.Item(PosicionActual).ProDireccion + "',`Txt_Punto_Ref` = '" + IUPrincipal.Personas.Item(PosicionActual).ProPuntoReferencia + "',`Txt_Tel_Habitacion` = '" + IUPrincipal.Personas.Item(PosicionActual).ProTelefonoHabitacion + "',`Txt_Tel_Movil` = '" + IUPrincipal.Personas.Item(PosicionActual).ProTelefonoMovil + "',`Txt_Correo` = '" + IUPrincipal.Personas.Item(PosicionActual).ProCorreoElectronico + "',`Txt_Nombre_Contacto` = '" + IUPrincipal.Personas.Item(PosicionActual).ProNombreContacto + "',`Txt_Descripcion_Contacto` = '" + IUPrincipal.Personas.Item(PosicionActual).ProDescripcionContacto + "',`Txt_Tel_Contacto` = '" + IUPrincipal.Personas.Item(PosicionActual).ProTelefonoContacto + "',`Txt_Tel_Movil_Contacto` = '" + IUPrincipal.Personas.Item(PosicionActual).ProTelefonoMovilContacto + "',`Txt_Grupo_Sanguineo` = '" + IUPrincipal.Personas.Item(PosicionActual).ProGrupoSanguineo + "',`Int_Altura` = '" & IUPrincipal.Personas.Item(PosicionActual).ProAltura & "',`Int_Peso` = '" & IUPrincipal.Personas.Item(PosicionActual).ProPeso & "',`Int_Talla_Pantalon` = '" & IUPrincipal.Personas.Item(PosicionActual).ProTallaPantalon & "',`Int_Talla_Calzado` = '" & IUPrincipal.Personas.Item(PosicionActual).ProTallaCalzado & "',`Txt_Talla_Camisa` = '" + IUPrincipal.Personas.Item(PosicionActual).ProTallaCamisa + "',`Boo_Lentes` = '" & Lentes & "',`Boo_Fuma` = '" & Fuma & "',`Boo_Operaciones` = '" & Operaciones & "',`Boo_Incapacitado` = '" & Incapacitado & "',`Txt_Alergias` = '" + IUPrincipal.Personas.Item(PosicionActual).ProAlergias + "',`Txt_Enfermedades` = '" + IUPrincipal.Personas.Item(PosicionActual).ProEnfermedades + "',`Int_Estatus` = '" & IUPrincipal.Personas.Item(PosicionActual).ProEstatus & "',`Int_Banco` = '" & IUPrincipal.Personas.Item(PosicionActual).ProBanco & "',`Txt_Cuenta_Bancaria` = '" + IUPrincipal.Personas.Item(PosicionActual).ProCuentaBancaria + "',`Boo_Certificado` = '" & Certificado & "',`Int_Profesion` = '" & IUPrincipal.Personas.Item(PosicionActual).ProProfesion & "',`Txt_Habilidades` = '" + IUPrincipal.Personas.Item(PosicionActual).ProHabilidades + "',`Int_Dedo1` = '" & IUPrincipal.Personas.Item(PosicionActual).ProDedo_1 & "',`Int_Dedo2` = '" & IUPrincipal.Personas.Item(PosicionActual).ProDedo_2 & "' where `Txt_Cedula`= '" + IUPrincipal.Personas.Item(PosicionActual).ProCedula + "';")
            End If
            '////////////////////////////////////////////////////////
            '////////////////////////////////////////////////////////
        End If
