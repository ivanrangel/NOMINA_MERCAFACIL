Public Class IUCitasPreEmpleo
    ...
    Private Sub cargardgrid()
        ...
        While i < IUPrincipal.Personas.Count
            If IUPrincipal.Personas.Item(i + 1).ProEstatus = "8" And IUPrincipal.Personas.Item(i + 1).ProFechaPreEmpleo = "1900-01-01" Then
                Mostrar = True
            End If
            If Mostrar Then
    ...
    Private Sub cargargrid2(ByVal fecha As Date)
        ...
        While i < IUPrincipal.Personas.Count
            If IUPrincipal.Personas.Item(i + 1).ProEstatus = "8" And IUPrincipal.Personas.Item(i + 1).ProFechaPreEmpleo = fecha.ToString("yyyy-MM-dd") Then
                Mostrar = True
            End If
            If Mostrar Then
    ...
    Private Sub BtnProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnProcesar.Click
        ...
        Dim query As String
        query = "UPDATE `nomina`.`personas` SET `Dte_Fechapreempleo`='" + DateTimePicker1.Value.ToString("yyyy-MM-dd") + "' WHERE"
    ...
    Private Sub BtnGuardarNuevaCita_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardarNuevaCita.Click
        ...
        bConexionExitosa = Conexion.Conectar
        Dim query As String
        query = "UPDATE `nomina`.`personas` SET `Dte_Fechapreempleo`='" + DateTimePicker2.Value.ToString("yyyy-MM-dd") + "' WHERE `Txt_Cedula` = '" + DgridAspirantes2.Item(0, DgridAspirantes2.CurrentRow.Index).Value + "';"
